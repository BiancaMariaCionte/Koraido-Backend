...
def generate_ratings_csv(firebase_uid):
    ...
    for rating in new_ratings:
        doc_id = f"{rating['userId']}_{rating['movieId']}"
        ratings_ref.document(doc_id).set(rating)

    print(f'✅ Firestore ratings updated for Firebase UID {firebase_uid} (user ID {user_id})')
